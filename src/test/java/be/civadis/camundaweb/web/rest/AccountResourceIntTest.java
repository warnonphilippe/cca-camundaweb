package be.civadis.camundaweb.web.rest;

import be.civadis.camundaweb.config.Constants;
import be.civadis.camundaweb.CamundawebApp;
import be.civadis.camundaweb.domain.Authority;
import be.civadis.camundaweb.domain.User;
import be.civadis.camundaweb.repository.AuthorityRepository;
import be.civadis.camundaweb.repository.UserRepository;
import be.civadis.camundaweb.security.AuthoritiesConstants;
import be.civadis.camundaweb.service.MailService;
import be.civadis.camundaweb.service.dto.UserDTO;
import be.civadis.camundaweb.service.dto.PasswordChangeDTO;
import be.civadis.camundaweb.web.rest.errors.ExceptionTranslator;
import be.civadis.camundaweb.web.rest.vm.KeyAndPasswordVM;
import be.civadis.camundaweb.web.rest.vm.ManagedUserVM;
import be.civadis.camundaweb.service.UserService;
...
@SpringBootTest(classes = CamundawebApp.class)
